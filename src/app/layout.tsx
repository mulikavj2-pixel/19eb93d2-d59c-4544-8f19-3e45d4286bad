...
export const metadata: Metadata = {
  title: "Coffee Haven - Premium Ethically Sourced Coffee",
  description: "Discover exceptional ethically sourced coffee delivered fresh to your door. Premium blends, single-origins, and subscriptions for true coffee lovers.",
  keywords: "coffee, specialty coffee, subscription, ethically sourced, fair trade, coffee shop, cafe",
  ...
  openGraph: {
    title: "Coffee Haven - Premium Coffee Delivered Fresh",
    description: "Experience exceptional coffee from ethical sources. Subscribe today for fresh, artisanal coffee delivered monthly.",
    type: "website",
    siteName: "Coffee Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766070256177-bfluos1a.jpg",
        alt: "Coffee Haven Premium Coffee"
      }
    ]
  },
  twitter: {
    ...
    title: "Coffee Haven - Premium Ethically Sourced Coffee",
    description: "Discover exceptional coffee delivered fresh. Fair-trade sourcing, expert roasting, perfect brewing.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766070256177-bfluos1a.jpg"]
  }
};
